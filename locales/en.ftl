...
app-menu-grave-directory = Grave directory

unsaved-changes = Unsaved changes
unknown-window = Unknown window
person-directory-title = Person Directory
grave-directory-title = Grave Directory
...
choose-cemetery = Choose a cemetery
no-cemeteries = No cemeteries yet
sqlite-cemetery = SQLite cemetery
open = Open
delete = Delete
cancel = Cancel
confirm-delete-cemetery-title = Delete { $name }?
confirm-delete-cemetery-description = This will permanently remove { $name } from your cemetery library.
...
tags = Tags
add-tag = Add tag
confirm-remove-tag-title = Remove tag?
confirm-remove-tag-description = Remove "{ $tag }" from this grave?
grave-canvas = grave { $grave }
no-persons-associated = No persons associated yet
graves = Graves
persons = Persons
search-people = Search names, dates, or tags
search-graves = Search grave tags
...
cemetery-deleted = Cemetery deleted.
could-not-delete-cemetery = Could not delete cemetery: { $error }
