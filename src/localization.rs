...
pub enum MessageId {
    ...
    AppMenuExportDb,
    AppMenuExportPdf,
    AppMenuDuplicateLastGrave,
    AppMenuPersonDirectory,
    AppMenuGraveDirectory,
    UnknownWindow,
    ...
    Tags,
    AddTag,
    ConfirmRemoveTagTitle,
    ConfirmRemoveTagDescription,
    GraveCanvas,
    NoPersonsAssociated,
    Graves,
    Persons,
...
impl MessageId {
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AppMenuEdit => "app-menu-edit",
            ...
            Self::AppMenuDuplicateLastGrave => "app-menu-duplicate-last-grave",
            Self::AppMenuPersonDirectory => "app-menu-person-directory",
            Self::AppMenuGraveDirectory => "app-menu-grave-directory",
            Self::UnknownWindow => "unknown-window",
            Self::PersonDirectoryTitle => "person-directory-title",
            Self::GraveDirectoryTitle => "grave-directory-title",
            ...
            Self::Tags => "tags",
            Self::AddTag => "add-tag",
            Self::ConfirmRemoveTagTitle => "confirm-remove-tag-title",
            Self::ConfirmRemoveTagDescription => "confirm-remove-tag-description",
            Self::GraveCanvas => "grave-canvas",
            Self::NoPersonsAssociated => "no-persons-associated",
            Self::Graves => "graves",
            Self::Persons => "persons",
            Self::SearchPeople => "search-people",
            Self::SearchGraves => "search-graves",
            ...
            Self::ToolDelimiter => "tool-delimiter",
            Self::ToolDelimiterWall => "tool-delimiter-wall",
            Self::ToolDelimiterRoad => "tool-delimiter-road",
